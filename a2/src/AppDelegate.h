...
- (void)renderOneFrame:(id)sender
{
    ...
    {
		if(demo.getWindow()->isActive())
		{
			mStartTime = demo.getTimer()->getMillisecondsCPU();
            
			demo.getKeyboard()->capture();
			demo.getMouse()->capture();
            
//			demo.frameRenderingQueued(mLastFrameTime);
			Ogre::Root::getSingleton().renderOneFrame();
            
			mLastFrameTime = demo.getTimer()->getMillisecondsCPU() - mStartTime;
		}
    }
    else
    {
