...
class Collectible : public GameObject {
  public:
    Collectible(Ogre::SceneManager *mgr, Ogre::String _entName, Ogre::String _meshName, Ogre::String _nodeName, Ogre::SceneNode* parentNode,
                   ...
                   btVector3 localInertia=btVector3(0,0,0), btQuaternion *rotation=0, Ogre::String hitSound = "media/OgreBall/sounds/pickup.wav");

    virtual void update(float elapsedTime);
    bool isHit;
    Ogre::String mHitSound;
};
...
class GoalObject : public GameObject {
 public:
  GoalObject(Ogre::SceneManager *mgr, Ogre::String _entName, Ogre::String nodeName,
             ...
             btVector3 localInertia=btVector3(0,0,0),  btQuaternion *rotation=0, Ogre::String hitSound = "media/OgreBall/sounds/hitGoal.wav");
  Ogre::String mHitSound;
  virtual void update(float elapsedTime);
};
...
class Collidable : public GameObject{
  ...
  public:
    Collidable(Ogre::SceneManager *mgr, Ogre::String _entName, Ogre::String _meshName, Ogre::String nodeName,
             ...
             btVector3 origin=btVector3(0,0,0), btVector3 scale=btVector3(1,1,1),
             btVector3 velocity=btVector3(0,0,0),
             btScalar mass=0.0f, btScalar rest=0.0f,
             btVector3 localInertia=btVector3(0,0,0),  btQuaternion *rotation=0, Ogre::String hitSound = "bumper.wav");
